...
// What happen with concrete material meets plastic material
...
const createBox = (width, height, depth, position) => {
    ...
    const shape = new CANNON.Box(new CANNON.Vec3(width * .5, height * .5, depth));
...
const tick = () =>
{
    ...
    // 1 / 60 -> 60fps
    // Copy position from Physics library to ThreeJS
